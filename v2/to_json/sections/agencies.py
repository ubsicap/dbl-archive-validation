def process_agencies_section(dom, json_dict):
    ...
    if len(agencies_sections) > 0:
        ...
        for agency_node in [n for n in agency_nodes if len(n.xpath("uid")) > 0]:
            ...
            json_dict["agencies"][agency_uid] = {"type": str(agency_node.tag)}
            for text_child in [
                "uid",
                "abbr",
                "url",
                ...
                if len(child_nodes) > 0:
                    json_dict["agencies"][agency_uid][text_child] = child_nodes[0].text
            for bool_child in [
                "content",
                "publication",
                "management",
                ...
                if len(child_nodes) > 0:
                    ...
                    json_dict["agencies"][agency_uid][bool_child] = bool_value
